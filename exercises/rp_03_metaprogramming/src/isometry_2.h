...
// TODO 2:
// refactor this to add a template on Scalar
...
struct Isometry2 {
  ...
  Isometry2(Scalar x, Scalar y, Scalar theta) : Isometry2(Vec3(x, y, theta)) {}
...
std::ostream& operator<<(std::ostream& os, const Isometry2& iso);
